    ...
    <section id="contact" className="py-20 px-6 bg-gradient-to-br from-background to-background/50">
      <div className="container mx-auto max-w-6xl">
        ...
        <div className="grid lg:grid-cols-2 gap-12">
          {/* Contact Form with white background in light theme */}
          <motion.div
          ...
          <motion.div
            ...
            className="space-y-8"
          >
            {/* Contact Details with white background in light theme */}
            ...
            {/* Social Links with white background in light theme */}
            <div className="glass-card p-8 rounded-2xl bg-white dark:bg-white/10 border border-gray-200 dark:border-white/20">
            ...
            {/* Quick Response with white background in light theme */}
            <motion.div
